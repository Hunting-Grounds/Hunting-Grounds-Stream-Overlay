...
const Form = ({ currentId, setCurrentId }) => {
  const [panelData, setPanelData] = useState({ name: '', kd: '', entry: '', maps: '', kost: '', kpr: '', srv: '', clutchwins: '', plant: '', disable: '', hs: '', atk: '', def: '', selectedFile: '' });
  ...
  const clear = () => {
    setCurrentId(0);
    setPanelData({ name: '', kd: '', entry: '', maps: '', kost: '', kpr: '', srv: '', clutchwins: '', plant: '', disable: '', hs: '', atk: '', def: '', selectedFile: '' });
  };

  const handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(updatePanel(currentId, panelData));
    clear();
  };
