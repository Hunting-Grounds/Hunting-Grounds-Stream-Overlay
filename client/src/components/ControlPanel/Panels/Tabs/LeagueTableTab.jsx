      ...
      <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
        ...
        <Row>
          <Col span={6}>
            ...
            <TextField name="leagueTableColorRow1" variant="outlined" label="Row 1 Color" fullWidth value={panelData.leagueTableColorRow1} onChange={(e) => setPanelData({ ...panelData, leagueTableColorRow1: e.target.value })} />
          ...
          <Col span={6}>
            ...
            <TextField name="leagueTableColorRow8" variant="outlined" label="Row 8 Color" fullWidth value={panelData.leagueTableColorRow8} onChange={(e) => setPanelData({ ...panelData, leagueTableColorRow8: e.target.value })} />
